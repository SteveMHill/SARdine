...
impl DemReader {
    ...
    pub fn get_dem_pixel_spacing_meters<P: AsRef<Path>>(
        ...
        if spatial_ref.is_projected() {
            ...
            // Convert degrees to meters using latitude-dependent scaling
            // At latitude φ: 1° longitude ≈ 111320 * cos(φ) meters
            //              1° latitude ≈ 111320 meters (constant)
            let meters_per_degree_lat = 111320.0;
            let meters_per_degree_lon = 111320.0 * center_lat.to_radians().cos();
    ...
    ///
    /// This function provides safe fallback values based on common DEM resolutions:
    /// - SRTM 1": ~30m
    /// - SRTM 3": ~90m  
    ...
    pub fn complete_terrain_flattening_pipeline(
        ...
        use crate::core::advanced_masking::{
