...
/// Processing pipeline constants (replaces magic numbers)
pub mod processing;
...
// Re-export processing constants
pub use processing::{
    bbox, calibration, coverage, db_conversion, merge, multilook, orbit, speckle,
    terrain_correction,
};
