...
impl ProcessingContext {
    ...
    pub fn to_json(&self) -> SarResult<String> {
        serde_json::to_string_pretty(self).map_err(|e| {
            crate::types::SarError::Processing(format!("JSON serialization failed: {}", e))
        })
    }
    ...
    pub fn to_yaml(&self) -> SarResult<String> {
        serde_yaml::to_string(self).map_err(|e| {
            crate::types::SarError::Processing(format!("YAML serialization failed: {}", e))
        })
    }
    ...
    pub fn save_json(&self, path: &std::path::Path) -> SarResult<()> {
        ...
        std::fs::write(path, json).map_err(|e| {
            crate::types::SarError::Processing(format!("Failed to write JSON: {}", e))
        })?;
    ...
    pub fn save_yaml(&self, path: &std::path::Path) -> SarResult<()> {
        ...
        std::fs::write(path, yaml).map_err(|e| {
            crate::types::SarError::Processing(format!("Failed to write YAML: {}", e))
        })?;
        log::info!("✅ Saved processing context to: {}", path.display());
        Ok(())
    }
    ...
    pub fn from_json_file(path: &std::path::Path) -> SarResult<Self> {
        let json = std::fs::read_to_string(path).map_err(|e| {
            crate::types::SarError::Processing(format!("Failed to read JSON: {}", e))
        })?;
        serde_json::from_str(&json).map_err(|e| {
            crate::types::SarError::Processing(format!("JSON deserialization failed: {}", e))
        })
    }
    ...
    pub fn from_yaml_file(path: &std::path::Path) -> SarResult<Self> {
        let yaml = std::fs::read_to_string(path).map_err(|e| {
            crate::types::SarError::Processing(format!("Failed to read YAML: {}", e))
        })?;
        serde_yaml::from_str(&yaml).map_err(|e| {
            crate::types::SarError::Processing(format!("YAML deserialization failed: {}", e))
        })
    }
}
...
impl ProcessingContextBuilder {
    ...
    pub fn build(self) -> SarResult<ProcessingContext> {
        Ok(ProcessingContext::new(
            self.product_info.ok_or_else(|| {
                crate::types::SarError::Processing("Missing product_info".to_string())
            })?,
            self.timing
                .ok_or_else(|| crate::types::SarError::Processing("Missing timing".to_string()))?,
            self.radar.ok_or_else(|| {
                crate::types::SarError::Processing("Missing radar parameters".to_string())
            })?,
            self.geometry.ok_or_else(|| {
                crate::types::SarError::Processing("Missing geometry".to_string())
            })?,
        ))
    }
}
