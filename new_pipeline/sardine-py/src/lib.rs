...
//! [`sardine_scene::run`] entry points used by the `sardine` CLI:
//!
...
/// See [`sardine_scene::run::ProcessOptions`] for field semantics.
#[pyfunction]
#[pyo3(signature = (
    safe,
    dem,
...
/// [`sardine_scene::run::GrdOptions`] for field semantics.
#[pyfunction]
#[pyo3(signature = (
    safe,
    output,
